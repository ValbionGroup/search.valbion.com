...
<head>
  ...
  <link rel="stylesheet" media="screen, print, handheld" type="text/css" href="assets/css/calculatrice.css" />
    ...
    <!-- OpenSearch -->
    <link title="FlashSearch" type="application/opensearchdescription+xml" rel="search" href="https://islandgame.fr/search/assets/opensearch.xml">
    <!-- Stylesheep custom -->
            ...
            <div class="row">
                <div class="col-md-8 aligned-to-quotes">
                    <form action="https://www.duckduckgo.com/?q=" method="GET">
                        <input type="search" class="form-control card-shadow" placeholder="Recherche avec DuckDuckGo" name="q" autofocus autocomplete="on">
                    </form>
                </div>
            ...
            <div class="row">
                <div class="col-md-8 aligned-to-quotes">
                    <form action="https://www.duckduckgo.com/?q=" method="GET" target="_blank">
                        <input type="search" class="form-control card-shadow" id="BarreDeRecherche" placeholder="Rechercher avec DuckDuckGo ou avec les réseaux sociaux ci-dessous" name="q" autofocus autocomplete="on">
                    </form>
                    <div class="row">
                    ...
                    <div class="alert alert-warning alert-dismissible">
                		  ...
                		  <h6>Cette page est en développement, elle va donc subir d'énorme mise à jour dans le futur !<br />  Vous pouvez suivre le dévellopement sur <a target="_blank" href="https://github.com/IslandGAMEgrp/search.islandgame.fr">Github</a></h6>
              		  </div>
          		</div>
                <div class="col-lg-4 col-md-4 col-sm-0">
                    ...
                    <div class="card">
                        <div class="card-body card-shadow">
                            ...
                            <a class="pointer" data-toggle="modal" data-target="#Settings"><span style="right: 10px" class="color-gate-text btn-settings"><i class="fa fa-cog" aria-hidden="true"></i></span>
                        </div>
                    </div>
                </div>
            </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <ul>
              <li>Developped by <a class="color-gate-text" href="https://thomasbnt.fr/" target="_blank">Thomas Bnt</a> & <a class="color-gate-text" href="https://luchack.fr/" target="_blank">Luc'HACK</a>- Version <span class="color-gate-text">1.0.1</span></li>
